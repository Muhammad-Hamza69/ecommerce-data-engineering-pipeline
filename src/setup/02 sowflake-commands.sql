...
-- agar hum kinesis agent chala ke s3 mein file dum karte hain or phir delete kar ke dubara run karte hain tu 
...
-- STEP1: CREATE ROLE FOR S3_INTEGRATION OR MODIFY THE EXISTING ROLE.
-- STEP2: CREATE INTEGRATION AND TAKE THE ARN AN SECRET KEY 
-- STEP3: SET THE ARN AND SECRET KEY IN ROLE.
-- STEP4: CREATE STAGE AND TRY TO LIST THE FILE WE HAVE ORDERS/CUSTOMERS TABLE 
